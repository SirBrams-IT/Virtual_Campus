...
<head>
    ...
    <!-- Title Page-->
    <title>Add Student | Tech Virtual Campus</title>
    ...
    <header>
        <nav>
            ...
            <ul id="navli">
                ...
                <li><a class="homeblack" href="assignproject.php">Course Status</a></li>
                <li><a class="homeblack" href="salaryemp.php">Payment</a></li> 
